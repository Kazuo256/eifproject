...
function love.load ()
  ...
  --effects[5]:send("offset", {-32,-32, 32,  0})
  --effects[6]:send("offset", {-32,-32, 32,  0})
end
...
function love.draw ()
  ...
  struct.draw_left_wall(effects[2], {-3,0,0}, {6,1})
  struct.draw_floor(effects[3], {-3,0,1}, {6,3})
  struct.draw_left_wall(effects[4], {-3,-1,-2}, {6,2})
  struct.draw_right_wall(effects[5], {0,-1,0}, {1,1})
  struct.draw_right_wall(effects[6], {0,-1,1}, {1,1})
